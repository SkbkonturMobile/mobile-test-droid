# Задача
Написать мобильное приложение, которое отображает список контактов и выполняет поиск по ним. Здорово, если приложение будет написано на Kotlin с использованием MV* подхода и минимум сторонних библиотек. Будет ли приложение на View или Compose, выбор остается за вами. Решенное задание выложить на GitHub/GitLab, код в архиве приниматься не будет.
